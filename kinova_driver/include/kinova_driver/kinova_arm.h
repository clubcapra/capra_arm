...
public:
  ...
  void
  cartesianVelocityWithFingersCallback(const kinova_msgs::PoseVelocityWithFingersConstPtr& cartesian_vel_with_fingers);
  void cartesianVelocityWithFingerVelocityCallback(
  ...
  bool startForceControlCallback(kinova_msgs::Start::Request& req, kinova_msgs::Start::Response& res);
  bool stopForceControlCallback(kinova_msgs::Stop::Request& req, kinova_msgs::Stop::Response& res);
...
private:
  ...
  ros::ServiceServer ovis_home_service_;
